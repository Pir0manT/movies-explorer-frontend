...
Клонировать репозиторий:
    ...
    git clone https://github.com/Pir0manT/movies-explorer-frontend.git
...
- Frontend:
  - Repository: https://github.com/Pir0manT/movies-explorer-frontend
  - Website: https://movexp.top61.ru
- Backend:
